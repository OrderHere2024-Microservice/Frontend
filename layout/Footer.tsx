...
const RenderPages = ({ title, pages }: { title: string; pages: string[] }) => (
  <Grid item xs={12} md={3}>
    ...
    <Box>
      {pages.map((text, index) => (
        <Typography
          key={index}
          sx={{ marginBottom: index !== pages.length - 1 ? '20px' : '0' }}
        >
          <Link href="#" sx={styleNew.linkStyle}>
            {text}
          </Link>
        </Typography>
      ))}
      ...
      >
        <Box
          sx={{
            ...
            minHeight: '100%',
            color: '#fff',
            paddingLeft: ['12px', '72px'],
            paddingRight: ['12px', '72px'],
            paddingTop: '100px',
            paddingBottom: '60px',
          }}
        >
          <Grid container spacing={3}>
            <Grid item xs={12} md={3}>
              ...
              <Box mt={2} sx={{ marginTop: '20px' }}>
                <IconButton sx={styleNew.redCircleBackground} color="inherit">
                  <TwitterIcon />
                </IconButton>
                <IconButton sx={styleNew.redCircleBackground} color="inherit">
                  <FacebookIcon />
