  ...
  return (
    <NextClientOnly>
      <Container maxWidth="false" sx={{
        ...
        <Box sx={{ mt: 8, py: 5, backgroundColor: "#333", width: '100%', minHeight: '100%', color: "#fff", paddingLeft: ['12px', '72px'], paddingRight: ['12px', '72px'], paddingTop: '100px', paddingBottom: '60px' }}>
